...
pub static STONE_ITEM_TAGS: &quickphf::PhfMap<&'static str, &'static str> =
    &::quickphf::PhfMap::new(
        4294967296,
        &[0, 0, 0, 0],
...
pub static IRON_INGOT_ITEM_TAGS: &quickphf::PhfMap<&'static str, &'static str> =
    &::quickphf::PhfMap::new(
        4294967296,
        &[0, 0, 0, 0],
...
pub static REGISTER_ITEM: &[RegisterItem] = &[
    ...
    RegisterItem {
        new: IronIngotItem::new,
        load: IronIngotItem::load,
        tags: IRON_INGOT_ITEM_TAGS,
        name: IronIngotItem::NAME,
    },
];
